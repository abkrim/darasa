...
- **Reino Nazarí (sub_entidad nazarí de `al-andalus`):** Cuarteto enriquecido el 2026-06-20 con la tesis doctoral de Juan José Sánchez Carrasco, *La Vega de Granada en el tránsito del Reino Nazarí al Reino de Granada: cambios políticos, económicos y sociales* (Universidad de Granada, 2021; dir. Carmen Trillo San José), <https://digibug.ugr.es/handle/10481/71756>. Citar siempre por el handle DIGIBUG, no por copias locales del PDF.
  - **Hecho (alcance "marco + ocaso"):** fichas de **Muhammad I** (marco económico de la Vega + Acequia Real 1238), **Abu-l-Hasan** (frase de parias marcada como invención de Pulgar; finca de 1472), **al-Zagal** (impronta sobre la Vega; capitulación tras Baza; nota numeración XIII) y **Boabdil** (párrafo de capitulaciones "lo que pudo ser y no fue"; desmitificación de la entrega/Pradilla; nota numeración XII), más cláusula económica en `al-andalus.yaml`. Spec con prosa exacta + páginas en `docs/enrichment/2026-06-20-nazari-sanchez-carrasco.md`.
  - **Hallazgo:** la tesis numera Boabdil = Muhammad XII y al-Zagal = Muhammad XIII (RAH usa XI/XII); las notas de numeración recogen ahora las tres convenciones, sin imponer ninguna.
  - **No tocado, a propósito:** los emires intermedios (Ismail II, Muhammad VII…). La tesis es estudio territorial de la Vega, no biografía de emires; enriquecerlos requeriría otras fuentes — no inventar presencia donde no la hay.
